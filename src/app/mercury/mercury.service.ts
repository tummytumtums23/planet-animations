...
export class MercuryService implements OnDestroy {
  ...
  public resize(): void {
    ...
    return new THREE.Mesh(
      ...
      new THREE.MeshPhongMaterial({
        map:         THREE.ImageUtils.loadTexture('assets/images/mercurymap.jpg'),
        bumpMap:     THREE.ImageUtils.loadTexture('assets/images/mercurybump.jpg'),
        bumpScale:   0.005,
