...
export class MarsService implements OnDestroy {
  ...
  public resize(): void {
    ...
    return new THREE.Mesh(
      ...
      new THREE.MeshPhongMaterial({
        map:         THREE.ImageUtils.loadTexture('assets/images/2_mars_4k.jpg'),
        bumpMap:     THREE.ImageUtils.loadTexture('assets/images/mars_elev_bump_4k.jpg'),
        bumpScale:   0.005,
       /* specularMap: THREE.ImageUtils.loadTexture('assets/images/mars_specular_4k.png'),*/
